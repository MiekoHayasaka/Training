public class StringTest{
	public static void main(String[] args){
		...
		System.out.println("文字列s5を全部小文字にすると"+s5.toLowerCase());
		System.out.println("文字列s5を全部大文字にすると"+s5.toUpperCase());

		String s6=" Java lesson ";
		System.out.println("s6の前後の空白を除去すると"+s6.trim());
		System.out.println("s6のlessonをtutorialすると"+s6.replace("lesson","tutorial"));
		
		//文字列連結
		StringBuilder sb=new StringBuilder();
		for(int i=0;i<100;i++){
			sb.append("Java"); //バッファに"Java"を追加
		}
